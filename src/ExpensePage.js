...
export class ExpensePage extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <StatsBody title="Expenses" totalID={this.totalID} dataTableFields={this.dataTableFields} agg={this.props.agg} cities={this.props.cities} selectedCities={this.props.selectedCities}>
                </StatsBody>
            </div>
        )
    }
